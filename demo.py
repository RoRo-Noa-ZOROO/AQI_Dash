...
if not st.session_state["logged_in"]:
    ...
    st.markdown(
        """
        <iframe title="Power BI Report" width="100%" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiZGJkYTk1NGQtNWUzMi00MmJhLThmZDMtNTAzOTNjMmRmZWM4IiwidCI6IjkzZTljMTgyLTdhOWMtNGI4YS04YzY1LTM3OTMyNDZlYzgzMyJ9" frameborder="0" allowFullScreen="true"></iframe>
        """,
        unsafe_allow_html=True,
    )
